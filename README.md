# Notez: Modern Android Productivity Sample

Notez is a feature-rich, offline-first note-taking application built to showcase modern Android
...
Notez allows users to capture and organize their thoughts through text
...
Notez is built with a focus on modern Android development:
...
Notez is licensed under the [Apache License 2.0](LICENSE). See the `LICENSE` file for
details.
